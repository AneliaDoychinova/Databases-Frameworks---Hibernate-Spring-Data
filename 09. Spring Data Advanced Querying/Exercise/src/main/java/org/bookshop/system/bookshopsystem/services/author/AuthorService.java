...
public interface AuthorService {
    ...
    List<String> getAllAuthorsNamesWhereFirstNameEndsWith(String str);
    List<String> getAllAuthorsAndCountOfTheirBooksCopies();
    int getAuthorsBooksCountFromProcedure(String firstName, String lastName);
}
